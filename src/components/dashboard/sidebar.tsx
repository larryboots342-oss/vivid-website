...
const allSidebarLinks = [
  ...
  { href: "/dashboard/subscription", label: "Licenses", icon: CreditCard, ownerOnly: false },
  { href: "/dashboard/billing", label: "Billing", icon: Receipt, ownerOnly: false },
  { href: "/dashboard/settings", label: "Settings", icon: Settings, ownerOnly: false },
  { href: "/admin", label: "Admin Panel", icon: Shield, ownerOnly: true },
];
      ...
      >
        ...
        <div className="p-6 pb-4">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              <span className="text-lg font-bold text-white tracking-tight">VIVID</span>
        ...
        <nav className="flex-1 px-3 py-2 space-y-1">
          ...
          {sidebarLinks.map((link) => {
            ...
            return (
              ...
              >
                {isActive && (
                  <div className="absolute inset-0 rounded-xl bg-vivid-primary/10 border border-vivid-primary/20" />
                )}
                {!isActive && (
                  <div className="absolute inset-0 rounded-xl bg-white/0 group-hover:bg-white/5 transition-colors duration-200" />
                )}
                <link.icon className={cn("w-5 h-5 relative z-10 transition-colors", isActive ? "text-vivid-primary" : "text-vivid-textDim group-hover:text-white")} />
        ...
        {/* User section */}
        <div className="p-3 border-t border-vivid-border/50 space-y-1">

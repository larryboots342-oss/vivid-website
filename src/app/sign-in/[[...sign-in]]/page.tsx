...
export const metadata: Metadata = {
  title: "Sign In",
  description: "Sign in to your VIVID account to access your dashboard, manage licenses, and configure your AI gaming assistant.",
...
const clerkAppearance = {
  ...
  elements: {
    ...
    alternativeMethodsBlockButton:
      "h-12 rounded-xl border border-white/10 bg-white/[0.04] text-vivid-textMuted hover:text-white hover:bg-white/[0.08] transition-all",
    alternativeMethodsBlockButtonText: "text-sm",
    signIn: {
      socialButtonsBlockButton: "h-12 rounded-xl border border-white/10 bg-white/[0.04] text-white hover:bg-white/[0.08]",
    },
  },
};

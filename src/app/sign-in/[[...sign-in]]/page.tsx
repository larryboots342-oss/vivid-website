...
const clerkAppearance = {
  ...
  elements: {
    ...
    alternativeMethodsBlockButton:
      "h-10 rounded-xl border border-white/10 bg-white/[0.04] text-vivid-textMuted hover:text-white hover:bg-white/[0.08] transition-all",
    alternativeMethodsBlockButtonText: "text-sm",
    signIn: {
      socialButtonsBlockButton: "h-11 rounded-xl border border-white/10 bg-white/[0.04] text-white hover:bg-white/[0.08]",
    },
  },
};
